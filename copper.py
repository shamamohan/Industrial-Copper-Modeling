...
if submit_button and flag==0:
            ...
            import pickle
            with open(r"C:/Users/shama/model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r"C:/Users/shama/scaler.pkl", 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"C:/Users/shama/t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"C:/Users/shama/s.pkl", 'rb') as f:
            ...
            new_sample_ohe = t_loaded.fit_transform(new_sample[:, [7]]).toarray()
            new_sample_be = s_loaded.fit_transform(new_sample[:, [8]]).toarray()
            new_sample = np.concatenate((new_sample[:, [0,1,2, 3, 4, 5, 6,]], new_sample_ohe, new_sample_be), axis=1)
            new_sample1 = scaler_loaded.fit_transform(new_sample)
            new_pred = loaded_model.predict(new_sample1)[0]
            new_pred = scaler_loaded.fit_transform(new_sample1)
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"C:/Users/shama/cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r"C:/Users/shama/cscaler.pkl", 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"C:/Users/shama/ct.pkl", 'rb') as f:
            ...
            new_sample_ohe = ct_loaded.fit_transform(new_sample[:, [8]]).toarray()
            new_sample = np.concatenate((new_sample[:, [0,1,2, 3, 4, 5, 6,7]], new_sample_ohe), axis=1)
            new_sample = cscaler_loaded.fit_transform(new_sample[:, :15])
            new_pred = cloaded_model.predict(new_sample)
            new_pred = cscaler_loaded.fit_transform(new_sample1)
            if new_pred==1:
